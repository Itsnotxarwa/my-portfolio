...
import audioFile from "../assets/antent - hope to see you again.mp3";
...
export default function MusicCard() {
  ...
  const handleMouseUp = () => {
    ...
    return(
        <>
        <div className="hidden md:flex bottom-4 right-4 z-50">
            ...
            className="card-music fixed z-50 cursor-grab active:cursor-grabbing"
            ...
            <div className="one">
                ...
                <div className="bar">
                    ...
                    {!isPlaying ? 
                    <Play size={16} stroke="none" className="color bi-fast-forward-fill" /> 
                    :
                    <Pause size={16} stroke="none" className="color bi bi-fast-forward-fill" /> 
                    }
                    </div>
                ...
                <div className="bar">
                    ...
                    >
                        ...
                        <path
                        d="M13 5.466V1.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384l-2.36 1.966a.25.25 0 0 1-.41-.192zm0 9v-3.932a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384l-2.36 1.966a.25.25 0 0 1-.41-.192z"></path></svg>
                    <svg
                    viewBox="0 0 16 16"
                    ...
                    >
                        ...
                        ></path>
                        <path d="M12 3v10h-1V3h1z" fill-rule="evenodd">
                        </path>
                        <path
